#!/usr/bin/env python3
"""Parse Shabab Alqithara RSS feed and check for Mustafa Kamal credits"""
...
url = "https://www.youtube.com/feeds/videos.xml?channel_id=UC0e4Rnb9u7b2YBWQN7e7B6A"
...
for entry in entries:
    ...
    print(f'{vid} | {published[:10]} | {title[:60]} | {marker}')
    if has_mustafa:
        print(f'  Desc: {description[:250]}')
